...
struct PlayerRankingInfo {
	static const uint32_t rank_mm = 2;
	static const uint32_t wins_mm = 3;
	static const uint32_t rank_wm = 7;
	static const uint32_t wins_wm = 8;
	static const uint32_t rank_danger = 10;
	static const uint32_t wins_danger = 11;
};
